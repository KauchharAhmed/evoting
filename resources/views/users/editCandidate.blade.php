 ...
 <div class="col-md-6">
                                ...
                                <div class="portlet box blue">
                                    ...
                                    <div class="portlet-body form">
                                             {!! Form::open(['url' =>'updateCandidateInfo','method' => 'post','role' => 'form','class'=>'form-horizontal','files' => true]) !!}
                                            <div class="form-body">
                                               <div class="form-group">
                                                    <label class="col-md-4 control-label">Membership Number <span style="color:red; font-weight: bold">*</span></label>
                                                    <div class="col-md-8">
                                                        <input type="text" class="form-control spinner" name="member_no" value="<?php echo $row->member_no; ?>" required="">
                                                </div>
                                              </div>
                                                <div class="form-group">
                                                    <label class="col-md-4 control-label">Voter Number <span style="color:red; font-weight: bold">*</span></label>
                                                    <div class="col-md-8">
                                                        <input type="text" class="form-control spinner" name="voter_no" value="<?php echo $row->voter_no; ?>" required="">
                                                </div>
                                              </div>
                                              ...
                                              <div class="form-group">
                                                    ...
                                                    <div class="col-md-8">
                                                        <textarea type="text" class="form-control spinner" name="address" placeholder="Address" required=""><?php echo $row->address; ?></textarea>
                                                        </div>
                                                </div>
