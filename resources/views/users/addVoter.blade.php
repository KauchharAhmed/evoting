 ...
 <div class="col-md-6">
                                ...
                                <div class="portlet box blue">
                                    ...
                                    <div class="portlet-body form">
                                             {!! Form::open(['url' =>'addVoterInfo','method' => 'post','role' => 'form','class'=>'form-horizontal','files' => true]) !!}
                                            <div class="form-body">
                                               ...
                                               <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                    <label class="col-md-4 control-label">Voter Mobile (Log In Id)<span style="color:red; font-weight: bold">*</span></label>
                                                    <div class="col-md-8">
                                               ...
                                               <div class="form-group">
                                                    <label class="col-md-4 control-label">Confirm Voter Mobile (Log In Id)<span style="color:red; font-weight: bold">*</span></label>
                                                    <div class="col-md-8">
                                               ...
                                               <div class="form-group" style="display: none">
                                                    <label class="col-md-4 control-label">National Id Number<span style="color:red; font-weight: bold">*</span></label>
                                                    <div class="col-md-8">
                                                ...
                                                <div class="form-group">
                                                    <label class="col-md-4 control-label">Confirm Email<span style="color:red; font-weight: bold">*</span></label>
                                                    <div class="col-md-8">
                                                        <input type="email" class="form-control spinner" name="confirm_email" required="">
