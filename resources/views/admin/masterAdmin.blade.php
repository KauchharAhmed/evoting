            ...
            <div class="page-header navbar navbar-fixed-top">
                ...
                <div class="page-header-inner ">
                    ...
                    <div class="page-logo">
                          ...
                          <span style="color:white; font-weight: bold">Super Admin Panel</span>
                        ...
                        <ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="false" data-auto-scroll="false" data-slide-speed="200" style="padding-top: 20px">
                            ...
                            <li class="heading">
                               ...
                               <li class="nav-item">
                                ...
                                <ul class="sub-menu">
                                    <li class="nav-item">
                                        <a href="{{URL::to('addAdmin')}}" class="nav-link">
                                            <i class="icon-diamond"></i>
                                            <span class="title">Add Admin</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{URL::to('manageAdmin')}}" class="nav-link">
                                            <i class="icon-diamond"></i>
                                ...
                                <ul class="sub-menu">
                                    <li class="nav-item">
                                        <a href="{{URL::to('addPost')}}" class="nav-link">
                                            <i class="icon-diamond"></i>
                                            <span class="title">Add Post</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{URL::to('managePost')}}" class="nav-link">
                                            <i class="icon-diamond"></i>
                                ...
                                <ul class="sub-menu">
                                    <li class="nav-item">
                                        <a href="{{URL::to('addElection')}}" class="nav-link">
                                            <i class="icon-diamond"></i>
                                            <span class="title">Add Election</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{URL::to('manageElection')}}" class="nav-link">
                                            <i class="icon-diamond"></i>
                                            <span class="title">Manage Election</span>
                                        </a>
                                    </li>
                                </ul>
                            </li>
                                ...
                                <ul class="sub-menu">
                                    <li class="nav-item">
                                        <a href="{{URL::to('addSymbol')}}" class="nav-link">
                                            <i class="icon-diamond"></i>
                                            <span class="title">Election Symbol</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{URL::to('manageSymbol')}}" class="nav-link">
                                            <i class="icon-diamond"></i>
                                            <span class="title">Manage Symbol</span>
                                        </a>
                                    </li>
                                </ul>
                            </li>-->
                               ...
                               <li class="nav-item">
                                ...
                                <ul class="sub-menu">
                                    <li class="nav-item">
                                        <a href="{{URL::to('addVoter')}}" class="nav-link">
                                            <i class="icon-diamond"></i>
                                            <span class="title">Add Voter</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{URL::to('pendingVoterList')}}" class="nav-link">
                                            <i class="icon-diamond"></i>
                                            <span class="title">Pending Voters</span>
                                        </a>
                                    </li>
                                      <li class="nav-item">
                                        <a href="{{URL::to('activeVoterList')}}" class="nav-link">
                                            <i class="icon-diamond"></i>
                                            <span class="title">Active Voters</span>
                                        </a>
                                    </li>
                                </ul>
                            </li>
                            <li class="nav-item">
                                ...
                                <ul class="sub-menu">
                                    <li class="nav-item">
                                        <a href="{{URL::to('addCandidate')}}" class="nav-link">
                                            <i class="icon-diamond"></i>
                                            <span class="title">Add Candidate</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{URL::to('manageCandidate')}}" class="nav-link">
                                            <i class="icon-diamond"></i>
                                ...
                                <a href="javascript:;" class="nav-link nav-toggle">
                                    <i class="icon-diamond"></i>
                                    <span class="title">ASSIGN CANDIDATES POST</span>
                                    <span class="arrow"></span>
                                </a>
                                <ul class="sub-menu">
                                    <li class="nav-item">
                                        <a href="{{URL::to('addAssiognCandidatePost')}}" class="nav-link">
                                            <i class="icon-diamond"></i>
                                            <span class="title">Add Candidate Post</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{URL::to('manageAssiognCandidatePost')}}" class="nav-link">
                                            <i class="icon-diamond"></i>
                                            <span class="title">Manage Candidate Post</span>
                                        </a>
                                    </li>
                                </ul>
                            </li>
                                ...
                                <a href="javascript:;" class="nav-link nav-toggle">
                                    <i class="icon-diamond"></i>
                                    <span class="title">UPDATE VOTER</span>
                                    <span class="arrow"></span>
                                </a>
                                <ul class="sub-menu">
                                    <li class="nav-item">
                                        <a href="{{URL::to('updateVoterList')}}" class="nav-link">
                                            <i class="icon-diamond"></i>
                                            <span class="title">Update Voter List</span>
                                        </a>
                                    </li>
                                </ul>
                            </li>
                                ...
                                <a href="javascript:;" class="nav-link nav-toggle">
                                    <i class="icon-diamond"></i>
                                    <span class="title">VOTING SCHEDULE</span>
                                    <span class="arrow"></span>
                                </a>
                                <ul class="sub-menu">
                                    <li class="nav-item">
                                        <a href="{{URL::to('addVotingDateAndTime')}}" class="nav-link">
                                            <i class="icon-diamond"></i>
                                            <span class="title">Add Voting Date / Time</span>
                                        </a>
                                    </li>
                                     <li class="nav-item">
                                        <a href="{{URL::to('manageVotingDateAndTime')}}" class="nav-link">
                                            <i class="icon-diamond"></i>
                                            <span class="title">Manage Voting Date / Time</span>
                                        </a>
                                    </li>
                                </ul>
                            </li>
                             ...
                             <li class="nav-item">
                                ...
                                <ul class="sub-menu">
                                       <li class="nav-item">
                                        <a href="{{URL::to('electionVoterList')}}" class="nav-link">
                                            <i class="icon-diamond"></i>
                                            <span class="title">Voter List</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{URL::to('postWiseElectionResultReport')}}" class="nav-link">
                                            <i class="icon-diamond"></i>
                                            <span class="title">Post Wise Result</span>
                                        </a>
                                    </li>
                                      <li class="nav-item">
                                        <a href="{{URL::to('electionResultReport')}}" class="nav-link">
                                            <i class="icon-diamond"></i>
                                            <span class="title">Election Result</span>
                                        </a>
                                    </li>
                                </ul>
                            </li>
