...
<html lang="en">
    ...
    <body class="">
        <div class="page-lock">
            ...
            <div class="page-body">
                <div class="lock-head"> GIVEN YOUR EMAIL ADDRESS</div>
                <div class="lock-body">
                    <div class="lock-cont">
                        <div class="lock-item">
...
@endif
        ...
        {!! Form::open(['url' => 'voterSendMobileVerificationCode','method' => 'post' , 'class'=> 'lock-form pull-left' ]) !!}
        <a style="color: white; font-weight: bold" href="{{URL::to('/')}}">Go To Log In Page</a>
        <br/>
        <span style="color:yellow">You Will Get A Verification Code In Your Email</span>
                                    <div class="form-group">
                                    <input class="form-control placeholder-no-fix" type="email" autocomplete="off" placeholder="Enter Your Email" name="email" / required=""> 
                                </div>
